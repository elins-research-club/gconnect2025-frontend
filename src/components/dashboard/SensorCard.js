...
const SensorCard = ({ title, value, unit, statusColor = "" }) => {
  return (
    <div className="bg-background-card p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center justify-center text-center border border-background-border transform hover:-translate-y-1 animate-fadeInUp">
