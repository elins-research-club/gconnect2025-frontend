    ...
    if (data.temperature && isValidThreshold(data.temperature)) {
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "temperature",
          severity: "warning",
          message: `Suhu terlalu rendah, tidak ideal untuk bertani`,
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "temperature",
          severity: "danger",
          message: `Suhu terlalu tinggi, tidak ideal untuk bertani`,
          timestamp: timestamp.toISOString(),
          value: temp,
    ...
    if (data.humidity && isValidThreshold(data.humidity)) {
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "humidity",
          severity: "warning",
          message: `Kelembapan udara terlalu rendah tidak ideal untuk bertani`,
          timestamp: timestamp.toISOString(),
          value: humidity,
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "humidity",
          severity: "warning",
          message: `Kelembapan udara terlalu tinggi tidak ideal untuk bertani`,
          timestamp: timestamp.toISOString(),
          value: humidity,
    ...
    if (data.soilHumidity && isValidThreshold(data.soilHumidity)) {
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "soilHumidity",
          severity: "danger",
          message: `Kelembapan tanah terlalu rendah tidak ideal untuk bertani`,
          timestamp: timestamp.toISOString(),
          value: soilHumidity,
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "soilHumidity",
          severity: "warning",
          message: `Kelembapan tanah terlalu tinggi tidak ideal untuk bertani`,
          timestamp: timestamp.toISOString(),
          value: soilHumidity,
    ...
    if (data.windSpeed && isValidThreshold(data.windSpeed)) {
      ...
      if (
        ...
        newAlerts.push({
          ...
          type: "windSpeed",
          severity: "danger",
          message: `Kecepatan angin terlalu tinggi dapat merusak tanaman`,
          timestamp: timestamp.toISOString(),
          value: windSpeed,
